          ...
          <div class="table-box">
            ...
            <div class="table-body white">
               <div class="table-header flex-v-center">
                    <div class="flex-one">首次访问时间/注册时间</div>
                    <span class="w-100">新增用户</span>
                    <span class="w-60">次日</span>
                    <span class="w-60">2日后</span>
                    <span class="w-60">3日后</span>
                    <span class="w-60">4日后</span>
                    <span class="w-60">5日后</span>
                    <span class="w-60">6日后</span>
                    <span class="w-60">7日后</span>
                    <span class="w-60">14日后</span>
                </div>
                <div class="table-content">
                    ...
                    <div class="table-item flex-v-center" v-if="detailList.length" v-for="(item,index) in detailList" :key="index">
                        ...
                        <div class="w-60">{{item.comment_num}}</div>
                        <div class="w-60">{{item.share_num}}</div>
                        <div class="w-60">{{item.like_num}}</div>
                        <div class="w-60">{{item.like_num}}</div>
                        <div class="w-60">{{item.like_num}}</div>
                        <div class="w-60">{{item.like_num}}</div>
                        <div class="w-60">{{item.like_num}}</div>
