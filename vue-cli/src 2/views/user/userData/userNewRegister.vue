      ...
      <div class="data-box" v-loading="allLoading">
          <div class="charts-box">
            ...
            <div class="charts-contain">
                <tab-box
                :tab-list="[{name:'用户比',id:'userRatio'}]"
          ...
          <div class="table-box">
            ...
            <div class="table-body white">
                <div class="table-header flex-v-center">
                    ...
                    <span class="w-100">新用户</span>
                    <span class="w-100">老用户</span>
                </div>
...
export default {
  ...
  methods: {
    ...
    handleTabChange (data) {
      ...
      switch (data.id) {
        case 'userRatio':
          this.chartsOptions.seriesData = [this.userRatio];
          break;
        default:
          break;
      }
      ...
      try {
        ...
        if (data.length) {
          data.forEach((vv) => {
            ...
            this.userRatio.push(vv.click_num);// todo
          });
