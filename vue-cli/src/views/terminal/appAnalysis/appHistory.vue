      ...
      <div class="data-box" v-loading="allLoading">
          ...
          <div class="charts-box">
            ...
            <div class="charts-contain">
                <tab-box
                :tab-list="[{name:'新增用户',id:'addUser'},{name:'活跃用户',id:'activeUser'},
                {name:'启动次数',id:'startNum'},{name:'活跃账号',id:'actives'}]"
      ...
      try {
        ...
        if (data.length) {
          data.forEach((vv) => {
            ...
            this.activeUser.push(vv.play_num);// todo
            this.startNum.push(vv.visit_num);// todo
            this.actives.push(vv.comment_num);// todo
          });
